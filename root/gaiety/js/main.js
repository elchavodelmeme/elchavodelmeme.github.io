...
$(window).on('load', function() {
	...
	/* -----------------------------------
			  2. Sound Setup
	----------------------------------- */
	$('body').append('<audio loop autoplay volume="1" id="audio-player"><source src="http://drive.google.com/uc?export=view&id=10l34jLpZEm4nUA7YGeJ4Z1RdWF3qT_Hx" type="audio/mpeg"></audio>');
