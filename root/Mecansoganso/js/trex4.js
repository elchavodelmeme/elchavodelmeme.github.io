...
function cargaImagenes() {
    ...
    imgCactus2.src = "img/ca1.png";
    imgCactus3.src = "img/ca2.png";
...
function puntuacion() {
    ...
    if (nivel.muerto == true) {
        //alert("AQUIIIII");
        ctx.font = "250% impact";
        ctx.fillText('me canso ganso, me volví corrupto', 40, 140);

    

        localStorage.setItem('tiposs','1')
        //alert("Juego Terminado");
        document.getElementById("btnPausar").click();
        //document.getElementById("btnRegistroRG").click();
